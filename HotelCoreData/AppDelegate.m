...
//        hotel.rating = hotelDictionary[@"rating"];
...
//    // The directory the application uses to store the Core Data store file. This code uses a directory named "Founder.HotelCoreData" in the application's documents directory.
...
//    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"HotelCoreData.sqlite"];
//    NSError *error = nil;
